<header id="header" class="module header w-full border-b-1 top-0 left-0 fixed z-200 down_lg:overflow-hidden bg-blue-100">
    <div class="container">
        <nav class="row navbar items-center">
            <div class="col w-full down_lg:flex down_lg:flex-wrap lg:w-1/5 header-mobile relative justify-between items-center">
                <div class=" flex lg:w-full relative">
                    <a id="header-logo" class="navbar-brand header-logo py-5 inline-flex align-middle"
